...
export function About() {
  const [profileAlt, setProfileAlt] = useState(false);
  ...
  return (
    <section
      id="home"
      className="scroll-section bg-bg-section pt-24 pb-16 md:pt-32 md:pb-24"
    >
      <div className="container-main">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <div className="relative mx-auto w-[min(100%,340px)] py-6 lg:max-w-[400px]">
              <ProfileFloralDecor />
              <div className="relative z-10 mx-auto aspect-square w-[min(100%,300px)] max-w-[320px]">
                ...
                <button
                  type="button"
                  data-swapped={profileAlt ? "true" : "false"}
                  onClick={toggleProfileOnMobile}
                  className="group/profile relative block h-full w-full cursor-pointer touch-manipulation overflow-hidden rounded-full border-[5px] border-bg-card shadow-[var(--shadow-card)] lg:cursor-default"
                  aria-label={
                    profileAlt
                      ? "Show primary profile photo"
                      : "Show alternate profile photo"
                  }
                >
                  <img
                    src={assets.profileDefault}
                    alt="Irish Suello"
                    className="absolute inset-0 h-full w-full object-cover transition-opacity duration-500 group-data-[swapped=true]/profile:max-lg:opacity-0 lg:group-hover/profile:opacity-0"
                    width={400}
                    height={400}
                  />
                  <img
                    ...
                    alt=""
                    aria-hidden
                    className="absolute inset-0 h-full w-full object-cover opacity-0 transition-opacity duration-500 group-data-[swapped=true]/profile:max-lg:opacity-100 lg:group-hover/profile:opacity-100"
                    width={400}
                    height={400}
                  />
                </button>
